#!/bin/bash
# Locator v1.0
# Recoded by: Dodi Lorentz (You dont become a coder by just changing the credits)
# Github [https://github.com/lulzsec87/locator.git]
...
printf "\n"
printf "\e[1;93m :::\e[0m\e[1;77m Recode by Dodi Lorentz\e[0m\n"
